...
arr distChars = [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE], [SPACE]
span
arr distColours = 
    (col reset white ), (col reset white ),
    (col reset cyan  ), (col reset cyan  ), 
    (col reset blue  ), (col reset blue  ), 
    (col reset magenta), (col reset magenta), 
    (col reset gray  ), (col reset gray  ), 
    (col reset gray  ), (col reset gray  )
span
